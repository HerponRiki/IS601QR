...
def generate_qr_code(data, path, fill_color='red', back_color='blue'):
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/HerponRiki')
